...
while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)) {
    ...
    echo '';
    echo '<div class="row"><div class="col-1 w3-text-dark-grey">Name</div><div class="col-10 w3-text-grey">'.$row['name'].'<span onclick="deleteContact(\''.$row['message_id'].'\')" class="w3-button w3-display-topright" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete Post">&#10060;</span></div></div>';
