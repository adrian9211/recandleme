...
<div class="container">
    <div class="row">
        <h2 class="text-center d-flex align-items-center justify-content-center pt-5">SELECT SCENTS TO BLEND TOGETHER</h2>
        <h6 class="text-center d-flex align-items-center justify-content-center pb-4">STEP TWO: PICK THE SCENT TO BLEND WITH</h6>
    </div>
</div>
...
<div class="container-fluid" style="width:90%">
    <div class="row mt-4 ms-5 ps-5">
        ...
        $query = "SELECT * FROM scents WHERE scent_type = 2";
        ...
        if (isset($_POST['addToCart'])) {
            ...
            if (mysqli_num_rows($r) == 1) {
                ...
                $_SESSION['cust'][2] = $row['scent_name'];
                # Close database connection.
                mysqli_close($dbc);
                echo '<script>location.href="custom-page-three.php";</script>';
            }
        }
